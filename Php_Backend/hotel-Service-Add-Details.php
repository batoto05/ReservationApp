...
`HotelAppartmentCategory`,`HotelRooms`,`HotelMessage`,`remiaingRooms`) VALUES (null,'{$HotelName}','{$HotelLocation}','{$HotelImage}','{$HotelAppartmentCategory}'
,'{$HotelRooms}','{$HotelMessage}','{$HotelRooms}')";
